...
????????? `web_search`?`drive_search`?`google_drive_search` ? `google_drive_fetch` ???????????????????????????????
...
????? `tzfile('/usr/share/zoneinfo/Atlantic/Reykjavik')`?
...
Claude ???? Google Drive ?????`drive_search` ?????? Google Drive ???????????????????????
??????????????????????????????? `drive_search`?
...
<search_instructions>  
Claude ???? `web_search` ????????`web_search` ??????????? `<function_results>` ??????????????????????????????????????????? `web_search`????????Claude ??????????????????????????????????????????????????????????Claude ?????????????????????????? 0 ????????????? 5 ??????????? `google_drive_search`?Slack?Asana?Linear ????????????????????????????
